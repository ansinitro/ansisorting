...
mod tests {
    ...
    #[test]
    fn test_insertion_sort_duplicate_elements() {
    ...
    #[test]
    fn test_insertion_sort_large_input() {
    ...
    #[test]
    fn test_insertion_sort_sorted_person() {
        let mut vec = vec![
            Person {
        ...
        insertion_sort(&mut vec, &|a, b| a.age < b.age);
        assert_eq!(
            vec,
            vec![
                Person {
    ...
    #[test]
    fn test_insertion_sort_random_person() {
        let mut vec = vec![
            Person {
                name: "Alice".to_string(),
                age: 30,
